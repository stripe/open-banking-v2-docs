...
{bank_name} members will have one or more of the following accounts:
- {bank_name} Personal Account
- {bank_name} Personal Savings Pot
- {bank_name} Joint Account
- {bank_name} Joint Savings Pot
- {bank_name} Business Current Account
- {bank_name} Business Savings Pot
...
`InterimAvailable` balance is the value displayed most widely to our members within the {bank_name} apps.
-
-## Transactions
